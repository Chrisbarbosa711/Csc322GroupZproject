...
fake_collaborator_db = {
    "paid_user": {
        "collaborators": ['paid_user2', 'paid_user3']
    }
}
    ...
    "requests": [
        {
            "id": "1",
            "word": "disgusting",
            "requestedBy": "paid_user2",
            "status": "pending",
            "requestDate": "2023-04-15",
            "reason": "This word is offensive and should be blacklisted"
        },
        {
            "id": "2",
            "word": "horrible",
            "requestedBy": "paid_user3",
            "status": "pending",
            "requestDate": "2023-04-16",
            "reason": "This word is negative and should be restricted"
        },
        {
            "id": "3",
            "word": "worst",
            "requestedBy": "paid_user4",
            "status": "approved",
            "requestDate": "2023-04-10",
            "reason": "This word is too negative"
        }
    ]
}
...
fake_complaints_db = {
    "complaints": [
        {
            "id": "1",
            "username": "paid_user", # 投诉者
            "collaborator": "paid_user2", # 被投诉者
            "projectName": "Marketing Campaign Copy",
            "subject": "Unauthorized Content Deletion",
            "content": "This collaborator deleted a significant portion of our work without discussion",
            "reason": "Around 2,500 words were removed from the 'Strategy' section without any communication or explanation",
            "deletedContent": "The deleted content included our entire marketing strategy section that took us 3 days to develop...",
            "status": "pending",
            "createdAt": "2023-06-13T09:22:00Z"
        },
        {
            "id": "2",
            "username": "paid_user3",
            "collaborator": "paid_user4",
            "projectName": "Product Documentation",
            "subject": "Collaborator Added Inappropriate Content",
            "content": "The collaborator inserted content that violates our company guidelines",
            "reason": "Added examples containing sensitive political statements in the public-facing API documentation",
            "deletedContent": "",
            "status": "pending",
        ...
        },
        {
            ...
            "subject": "Plagiarism in Collaborative Document",
            "content": "The collaborator copied content from another published paper without attribution",
            "reason": "I found that the 'Background' section added by this user was copied verbatim from a paper published in IEEE last year",
            "deletedContent": "",
            "status": "resolved",
        ...
        },
        {
            "id": "4",
            "username": "paid_user4",
            "collaborator": "paid_user3",
            "projectName": "Code Documentation",
            "subject": "Sabotage of Project",
            "content": "This collaborator deliberately corrupted our codebase documentation",
            "reason": "All API endpoints were changed to incorrect values, and the setup instructions were altered to include steps that would break the installation",
            "deletedContent": "",
            "status": "rejected",
            "createdAt": "2023-06-08T14:25:00Z"
        },
        {
            "id": "5",
            "username": "paid_user",
            "collaborator": "paid_user2",
            "projectName": "Business Proposal",
            "subject": "Unauthorized Access to Restricted Sections",
            "content": "This collaborator accessed and modified financial data they weren't supposed to see",
            "reason": "The pricing section was restricted to admins only, but they somehow gained access and changed all our pricing information",
            "deletedContent": "",
            "status": "in_progress",
...
# mock incorrection suggestions database
fake_suggestions_db = {
    "suggestions": [
        {
            "id": "1",
            "username": "paid_user",
            "originalText": "The company has made significant progress in the last quarter, with revenue increasing by 15% and customer satisfaction rates improving by 8 points.",
            "llmSuggestion": "The company has made significant progress in the last quarter, with revenue increasing by 15 percent and customer satisfaction rates improving by eight points.",
            "userExplanation": "The LLM changed '15%' to '15 percent' and '8' to 'eight', but in business writing, using percentage symbols and numerals is standard and preferred for clarity and brevity.",
            "status": "pending",
        ...
        },
        {
            "id": "2",
            "username": "paid_user2",
            "originalText": "The code implements quicksort, which has O(n log n) average time complexity.",
            "llmSuggestion": "The code implements quicksort, which has O(n-log-n) average time complexity.",
            "userExplanation": "The LLM incorrectly changed the standard mathematical notation. In computer science, 'O(n log n)' is the correct notation for this time complexity, not 'O(n-log-n)'.",
            "status": "pending",
        ...
        },
        {
            "id": "3",
            "username": "paid_user3",
            "originalText": "Dr. Smith's research on AI ethics was published in 2023.",
            "llmSuggestion": "Dr. Smith's research on AI ethics was published in 2022.",
            "userExplanation": "The LLM incorrectly changed the year of publication. The research was definitely published in 2023, not 2022. This is factually incorrect.",
            "status": "approved",
        ...
        },
        {
            "id": "4",
            "username": "paid_user4",
            "originalText": "The experiment yielded p < 0.05, indicating statistical significance.",
            "llmSuggestion": "The experiment yielded p < 0.05, indicating strong statistical significance.",
            "userExplanation": "The LLM added 'strong' which is misleading. In statistical analysis, p < 0.05 only indicates statistical significance, not necessarily 'strong' significance. The strength would depend on the effect size and other factors.",
            "status": "rejected",
        ...
        },
        {
            "id": "5",
            "username": "paid_user",
            "originalText": "According to APA style, citations should include the author's last name and year (Smith, 2023).",
            "llmSuggestion": "According to APA style, citations should include the author's last name and year, e.g., Smith (2023).",
            "userExplanation": "The LLM changed the correct APA in-text citation format. The format should be (Smith, 2023) not Smith (2023) for a standard in-text citation.",
            "status": "pending",
            "createdAt": "2023-05-19T10:05:00Z"
        }
    ]
}
